;(function (angular) {
	...
	*/
	...
	// begin charts
	angular.module('ChartCtrls', ['Charts'])
	
		.controller('serveruptimeChartCtrl', ['$scope', function ($scope) {
		...
		.controller('cpuChartCtrl', ['$scope', function ($scope) {
			// data and options passed to chart directive in /app/js/directives/charts.js
			$scope.model = {};
		...
		.controller('trafficChartCtrl', ['$scope', function ($scope) {
			$scope.model = {};
